...
*/
var query = function (sql, values) { return __awaiter(void 0, void 0, void 0, function () {
...
var transaction = /** @class */ (function () {
     ...
     * 创建数据库连接
     */
    transaction.prototype.createConection = function () {
    ...
    transaction.prototype.beginTransaction = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createConection()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                try {
    ...
    transaction.prototype.commit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        try {
                            _this.connection.commit(function (err, info) {
                                if (err) {
                                    reject(err);
                                }
                                else {
     ...
     * @param values
     */
    transaction.prototype.query = function (sql, values) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
