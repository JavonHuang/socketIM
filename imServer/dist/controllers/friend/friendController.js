...
var friendBll = __importStar(require("../../BLL/friend/friendBll"));
var MainController = /** @class */ (function () {
    ...
    * @param ctx 用户注册
    */
    MainController.prototype.getUserFriendById = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var req, reqBody, _a, e_1, _b;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (reqBody.userid == null || reqBody.userid == '') {
                            throw new Error("verify: userid 不可为空或null");
                        }
                        _a = ctx;
                        return [4 /*yield*/, friendBll.getUserFriendById(reqBody)];
                    case 1:
                        _a.body = _c.sent();
                        return [3 /*break*/, 4];
                    case 2:
    ...
    __decorate([
        koa_controllers_1.Post('/friend/getUserFriendById'),
        __param(0, koa_controllers_1.Ctx),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", Promise)
    ], MainController.prototype, "getUserFriendById", null);
